...
companyNumber = pd.read_excel("yahoostock.xlsx",sheet_name="Sheet",usecols=[1])
...
#indexNumber = int(result[1])
#print(indexNumber)

#print(companyName_list[indexNumber]+ " " + companyNumber_list[indexNumber])

#for i in range(s):
 #   if searchTitle in companyName[i]:
  #      print(companyName[i] + " " + companyNumber[i])
